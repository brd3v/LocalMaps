...
import { View, Text,SafeAreaView, Platform, FlatList,TouchableOpacity, Image, ActivityIndicator } from "react-native";
...
const filteredData = markers.filter((m) =>m.category === filter)
  ...
  useEffect(() => {
    fetch('http://192.168.49.191:3000/store').then(async (request) =>{
